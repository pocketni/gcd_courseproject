...
TIME DOMAIN SIGNALS	
	Variables with the prefix time." are signals captured in time.
	Jerk signals represent the body linear acceleration (accelerometer) OR angular velocity (gyrometer)
		with respect to time. In other words, the rate of change of acceleration
...
time.body.accelerometermagnitude.stddev
...
time.gravity.accelerometermagnitude.stddev
...
frequency.body.accelerometermagnitude.stddev
